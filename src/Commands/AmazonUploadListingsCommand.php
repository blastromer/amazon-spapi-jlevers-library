...
class AmazonUploadListingsCommand extends Command
{
    use ConsoleOutput, TimeStamp;

    protected $signature = 'amz-spapi:upload:listings
        ...
        foreach ($items as $item) {
            ...
            if (isset($response['error'])) {
                ...
                if ($uploadStatus == 'ACCEPTED') {
                    ...
                    \Log::info("SKU [{$sellerSku}] was successfully uploaded with the status of [{$uploadStatus}]");
                } else {
    ...
    public function aggregateData($item)
    {
        ...
        if ($product->count() > 0) {
            ...
            // $bulletPoints = [
            //     [
            //         "value" => "Faster, Safer, and More Reliable Connections: press jaw streamlines pipe installations by eliminating the need for sweating and soldering, reducing both labor time and safety risks. Designed for copper and copper tube-sized stainless steel pipes, it provides a flameless connection method, minimizing fire hazards while ensuring strong, tamper-proof joints for long-lasting results."
            ...
            //     ],
            //     [
            //         "value" => "Leak-Proof Joints That Prevent Costly Repairs: Designed for residential, commercial, and industrial applications, this press jaw ensures secure, watertight connections that resist leaks, corrosion, and tampering. By reducing the risk of water damage and costly repairs, it provides long-term peace of mind for professionals and building owners alike."
            ...
            //     ],
            //     [
            //         "value" => "Compact, One-Handed Operation for Tight Spaces: The in-line, ergonomic design allows for one-handed operation, providing exceptional maneuverability in cramped areas, around existing pipes, and in confined spaces. This reduces strain on the user, cuts down labor time, and ensures a more efficient installation process."
            ...
            //     ],
            //     [
            //         "value" => "Universal Compatibility for Maximum Versatility: With compatibility across Viega ProPress, Elkhart APOLLOXPRESS, and Grinnel G-Press copper systems, this press jaw eliminates the need for multiple tools, making it a versatile and cost-effective choice for professionals working with various fittings."
            ...
            if (!$catalogItems) {
                ...
                if (!is_array($suggestedCatalogAttr) && !is_null($suggestedCatalogAttr->getPayload()) && $suggestedCatalogAttr->getPayload()->items != []) {
            ...
            if ($itemCatalogNew != []) {
                ...
                if (!is_null($itemNew->asin) || $asin != $itemNew->asin) {
                    ...
                    if (is_null($productType) || empty($productType)) {
        ...
        $data = [
            ...
            'attributes'    => [
                ...
                "item_shape"            => [[ "value" => 'Rectangular', 'marketplace_id' => $marketplaceId ]],
                ...
                "seasons"   => [[ "value" => "All Seasons", 'marketplace_id' => $marketplaceId ]],
                "number_of_channels"   => [[ "value" => "1", 'marketplace_id' => $marketplaceId ]],
                "paper_finish"   => [[ "value" => "smooth", 'marketplace_id' => $marketplaceId ]],
                "print_media_type"   => [[ "value" => "unknown", 'marketplace_id' => $marketplaceId ]],
                "paper_weight"   => [[ "value" => "10", 'marketplace_id' => $marketplaceId ]],
                "manufacturer_minimum_age"   => [[ "value" => "0", 'marketplace_id' => $marketplaceId ]],
                "manufacturer_maximum_age"   => [[ "value" => "10", 'marketplace_id' => $marketplaceId ]],
                "coverage"   => [[ "value" => "Not Applicable", 'marketplace_id' => $marketplaceId ]],
                "specialty"   => [[ "value" => "Not Applicable", 'marketplace_id' => $marketplaceId ]],
                "color_code"   => [[ "value" => "#000000", 'marketplace_id' => $marketplaceId ]],
                "paint_type"   => [[ "value" => "Mineral", 'marketplace_id' => $marketplaceId ]],
                "gem_type"   => [[ "value" => "unknown", 'marketplace_id' => $marketplaceId ]],
                "stones"   => [
                    [
                        "id" => 1,
                        "number_of_stones" => 1,
                ...
                "metals"   => [
                    [
                        ...
                        "metal_stamp" => [
                            "language_tag" => "en_US",
                            "value" => "No Metal Stamp"
                        ],
                        "metal_weight" => [
                            "value" => 10.5, // Weight value
                            "unit" => "grams"
                        ],
                    ]
                ],
                "flavor"   => [[ "value" => "unknown", 'marketplace_id' => $marketplaceId ]],
                "educational_objective"   => [[ "value" => "unknown", 'marketplace_id' => $marketplaceId ]],
                "occasion"   => [[ "value" => "Halloween", 'marketplace_id' => $marketplaceId ]],
                "liquid_volume"   => [[ "value" => 10, "unit" => "unknown_modifier", 'marketplace_id' => $marketplaceId ]],
                "temperature_rating"   => [[ "value" => "Ambient: Room Temperature", 'marketplace_id' => $marketplaceId ]],
                ...
                "frame" => [
                    [
                        ...
                        "material" => [
                            [
                                "language_tag" => "en_US",
                                "value" => "unknown" // Must be a valid type from the list
                            ]
                        ],
                        "joint_type" => [
                            [
