...
class PullProductTypeByAsinCommand extends Command
{
    use ConsoleOutput, TimeStamp;

    protected $signature    = 'amz-spapi-test:search-catalog:using-asin';
    ...
    public function handle()
    {
        ...
        $response = $this->catalog->getProductTypeByAsin('B008J527AY');
